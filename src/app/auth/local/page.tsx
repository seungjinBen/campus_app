    ...
    <main className="flex min-h-screen flex-col items-center justify-center px-6 bg-brand-cream">
      <div className="w-full max-w-sm space-y-6">
        ...
        <div className="text-center space-y-2">
          ...
          <h1 className="text-xl font-bold text-brand-dark pt-2">개발자 로그인</h1>
          <p className="text-sm text-brand-mid">처음 입력하는 이메일은 자동으로 계정이 생성돼요</p>
        </div>
